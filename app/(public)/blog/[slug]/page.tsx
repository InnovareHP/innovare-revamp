...
export const generateMetadata = async ({
  ...
  if (!post) {
    return {
      title: "Blog not found | Innovare HP",
  ...
  return {
    ...
    description:
      post.company_blog_excerpt ?? post.company_blog_content.slice(0, 160),
    openGraph: {
      title: post.company_blog_title,
      description:
        post.company_blog_excerpt ?? post.company_blog_content.slice(0, 160),
      url: `https://www.innovarehp.com/blog/${slug}`,
      images: post.company_blog_featured_image
        ? [
            {
              url: post.company_blog_featured_image,
              width: 1200,
              height: 630,
    ...
    keywords: post.company_blog_tags?.map((tag) => tag.company_blog_tag_name),
  };
};
          ...
          {post.company_blog_featured_image && (
            <div className="mb-8 relative">
              <Image
                ...
                width={1200}
                height={600}
                className="rounded-xl w-full shadow-2xl object-contain"
                priority
              />
